/**
 * Minimal NetworkTables Client for OutlineViewer
 * 
 * This is a minimal client that connects to OutlineViewer when it's in server mode.
...
// Create a log file
const logStream = fs.createWriteStream('outlineviewer-minimal-client.log', { flags: 'a' });
...
// Start the client
log('Minimal NetworkTables Client for OutlineViewer');
