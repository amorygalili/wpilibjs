...
/**
 * NetworkTables Double Array entry.
 */
export class DoubleArrayEntry {
  private topic: DoubleArrayTopic;
   ...
   */
  constructor(topic: DoubleArrayTopic, defaultValue: number[]) {
    this.topic = topic;
   ...
   * @returns Topic
   */
  public getTopic(): DoubleArrayTopic {
    return this.topic;
  }
