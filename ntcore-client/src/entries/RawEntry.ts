...
export class RawEntry {
  private topic: RawTopic;
  private defaultValue: Uint8Array;
   ...
   */
  constructor(topic: RawTopic, defaultValue: Uint8Array) {
    this.topic = topic;
   ...
   */
  public setDefault(value: Uint8Array): void {
