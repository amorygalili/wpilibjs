...
/**
 * NetworkTables Float Array entry.
 */
export class FloatArrayEntry {
  private topic: FloatArrayTopic;
   ...
   */
  constructor(topic: FloatArrayTopic, defaultValue: number[]) {
    this.topic = topic;
   ...
   * @returns Topic
   */
  public getTopic(): FloatArrayTopic {
    return this.topic;
  }
