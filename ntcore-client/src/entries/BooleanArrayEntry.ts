...
/**
 * NetworkTables Boolean Array entry.
 */
export class BooleanArrayEntry {
  private topic: BooleanArrayTopic;
   ...
   */
  constructor(topic: BooleanArrayTopic, defaultValue: boolean[]) {
    this.topic = topic;
   ...
   * @returns Topic
   */
  public getTopic(): BooleanArrayTopic {
    return this.topic;
  }
