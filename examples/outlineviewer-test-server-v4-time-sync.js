/**
 * NetworkTables Server Test for OutlineViewer (Version 4 - Time Sync)
 *
 * This example creates a NetworkTables server that uses MessagePack for binary encoding
 * to communicate with OutlineViewer, with special handling for time synchronization messages.
 */
...
// Create a log file
const logStream = fs.createWriteStream('outlineviewer-test-server-v4-time-sync.log', { flags: 'a' });
