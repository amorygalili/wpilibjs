/**
 * Simple test program that just starts the NetworkTables server on port 5810.
 * 
 * This program starts the NetworkTables server on port 5810 and waits for connections.
 */
import { networkTables } from '../src';

// Start the NetworkTables server
console.log('Starting NetworkTables server on port 5810...');
