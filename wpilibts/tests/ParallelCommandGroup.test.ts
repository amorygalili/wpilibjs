...
import { ParallelCommandGroup } from '../src/commands/ParallelCommandGroup';
...
describe('ParallelCommandGroup', () => {
  ...
  test('should initialize all commands', () => {
    ...
    const group = new ParallelCommandGroup(command1, command2);
  ...
  test('should end commands that finish', () => {
    const command1 = new TestCommand([subsystem1]);
    const command2 = new TestCommand([subsystem2]);
